        ...
        <Nav />
         <div className="about col-5">
         {
             storyText.map((item, id) => {
                    ...
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-3">
                        ...
                        <div className="d-flex about__info">
                          <span className="me-1">Today</span> ·
                          <span className="ms-1 me-1">1 min ago</span> ·
              ...
              If yes, then you are not alone. We all feel unproductive, tired, and lazy all day after a series of trouble and challenges in life. But, these problems can easily be overcome by following some of the best products and self-improvement tools and apps. With the Increase in a surge of industrialization and globalization, we all are so much dependent on apps and software to do our work easier and more productive, don’t we?
                      </p>
                    </div>

                    <div className="comment__cmbox d-flex">
                      <button className="comment__cmbtn">
                        <svg
                          ...
                          <span className="ps-2">{item.like}</span>
                        </button>
                      <button onClick={mopenHandler} className="comment__cmbtn"><svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        aria-label="responses"><path
                      ...
                      <span className="ps-2">{item.comment}</span>
                      </button>
               ...
               if(item.id === +location.pathname.split("/").at(-1)) {
                return(
                  ...
                  <div className="about__box">
                    ...
                    <div className="comment__cmbox d-flex">
                      <button onClick={() => setCount (count + 1)} className="comment__cmbtn">
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                          ...
                          <span className="ps-2">{count}</span>
                        </button>
                      <button onClick={mopenHandler} className="comment__cmbtn"><svg
                        width="24"
                        height="24"
